...
- 細かい点とはなりますが、以下の点の修正をお願い致します。

## products
- cd_titleはtitleと定義したほうが直感的でより良いかと思います。

## songs,Labels,Artists,Genres
- 各種名称カラムをnameに変更の方お願いします。「Artistsの中のartist」となると、名称が曖昧となるため、はっきりと「name」と書いてしまった方が分かりやすく理想的です。
